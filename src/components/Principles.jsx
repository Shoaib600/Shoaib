...
export default function Principles() {
  return (
    <section id="principles" className="bg-panel px-6 sm:px-16 py-24 sm:py-32">
      ...
      <div className="grid sm:grid-cols-2 gap-10">
        {PRINCIPLES.map((p) => (
          <div key={p.n}>
            <span className="text-accent-muted text-sm font-display">{p.n}</span>
            <h3 className="font-display text-cream text-lg font-medium mt-2 mb-2">{p.title}</h3>
